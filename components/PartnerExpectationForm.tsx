...
const PartnerExpectationForm: React.FC<Props> = ({ options, stored }) => {
  ...
  const pickerBase = { backgroundColor: colors.inputBackground, borderColor: colors.inputBorder } as const;

  return (
    <View style={{ backgroundColor: colors.cardBackground }}>
      <Text style={labelStyle}>General Requirement</Text>
      <TextInput
        style={[styles.input, inputBase, { height: 80 }]} multiline value={form.general_requirement} onChangeText={(t) => handleChange('general_requirement', t)}
      />

      <Text style={labelStyle}>Country</Text>
      <Picker selectedValue={form.country} onValueChange={(v) => handleChange('country', v)} style={[styles.picker, pickerBase]}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        <View style={{ flex: 1, marginRight: 8 }}>
          <Text style={labelStyle}>Religion</Text>
          <Picker selectedValue={form.religion} onValueChange={(v) => handleChange('religion', v)} style={[styles.picker, pickerBase]}>
            <Picker.Item label="Select One" value="" />
        ...
        <View style={{ flex: 1 }}>
          <Text style={labelStyle}>Face Colour</Text>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        <View style={{ flex: 1, marginRight: 8 }}>
          <Text style={labelStyle}>Smoking Habits</Text>
          <Picker selectedValue={form.smoking_status} onValueChange={(v) => handleChange('smoking_status', v)} style={[styles.picker, pickerBase]}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        <View style={{ flex: 1, marginRight: 8 }}>
          <Text style={labelStyle}>Minimum Degree</Text>
      ...
      {/* Languages Tag Input */}
      <Text style={labelStyle}>Languages</Text>
